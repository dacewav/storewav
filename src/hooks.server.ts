...
export const handle: Handle = async ({ event, resolve }) => {
	...
	const csp = [
		"default-src 'self'",
		"script-src 'self' 'unsafe-inline' 'unsafe-eval' https://apis.google.com https://accounts.google.com https://www.gstatic.com https://js.stripe.com https://static.cloudflareinsights.com https://*.firebaseio.com https://dacewav-store-3b0f5-default-rtdb.firebaseio.com",
