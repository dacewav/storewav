...
**DERECHOS DE USO, TÉRMINOS Y CONDICIONES**

***BEAT / PRODUCCIÓN MUSICAL — EXCLUSIVA***

**DATOS DE LA OPERACIÓN**



|**No. de contrato:**|**[001 - 2026]**|
| :- | :- |
...
|**Forma de pago:**|**[ ] PayPal   [ ] SPEI   [ ] Mercado Pago   [ ] Otra**|
| :- | :- |
...
|**Formato entregado:**|**[ \* ] MP3   [ \* ] WAV   [ \* ] Stems   [ \* ] Todos**|
| :- | :- |
...
|**Precio pactado:**|**$ [CANTIDAD NEGOCIADA]** **MXN** / **USD (negociado)**|
| :- | :- |
...
**CLÁUSULA II. OBLIGACIONES DEL PRODUCTOR**
...
2\.3  Uso para portafolio: El PRODUCTOR podrá mantener el beat en YouTube, BeatStars (como preview no-comprable), SoundCloud, redes sociales y su página web personal, únicamente con fines de exposición y portafolio, sin ofrecerlo para venta ni licenciamiento comercial a terceros. El beat deberá incluir una nota visible de "EXCLUSIVA — No disponible para compra" o similar, para evitar confusión.

**CLÁUSULA III. DERECHOS RESERVADOS POR EL PRODUCTOR**
...
**CLÁUSULA IV. REGALÍAS Y PORCENTAJES**
...
**"70% ARTISTA / 30% PRODUCTOR en ingresos brutos del máster"**

**CLÁUSULA V. RECONOCIMIENTO DE LICENCIAS ANTERIORES**
...
**CLÁUSULA VI. CONTENT ID Y PROTECCIÓN DE LICENCIATARIOS ANTERIORES**
...
**CLÁUSULA VII. CRÉDITOS OBLIGATORIOS**
...
**CLÁUSULA VIII. RESTRICCIONES Y PROHIBICIONES**
...
**CLÁUSULA IX. GARANTÍAS E INDEMNIDAD**
...
**CLÁUSULA X. PAGO Y CONDICIONES ECONÓMICAS**

El ARTISTA realizó el pago único e irrepetible de: $\_\_\_\_\_\_\_\_\_\_\_\_\_\_ MXN / USD (cantidad acordada entre las partes y confirmada por comprobante de pago adjunto o enviado por mensaje)
...
**CLÁUSULA XII. CONDICIONES GENERALES**
...
12\.8  Cesión por parte del PRODUCTOR: El PRODUCTOR podrá ceder los derechos y obligaciones de este contrato a un tercero (por ejemplo, en caso de venta de su catálogo de producciones), previa notificación escrita al ARTISTA con al menos 15 (quince) días de anticipación. El cesionario asumirá todas las obligaciones del PRODUCTOR bajo este contrato. El ARTISTA podrá oponerse a la cesión únicamente si el cesionario no garantiza el cumplimiento de las obligaciones contractuales.

12\.9  Definición de incumplimiento grave: Se consideran incumplimientos graves, de manera enunciativa más no limitativa: (a) omisión del crédito obligatorio; (b) registro no autorizado en sistemas de Content ID; (c) cesión, venta o sublicenciamiento del beat o stems a terceros; (d) no configurar el split del 30% en el distribuidor al momento del lanzamiento, o desactivarlo sin autorización escrita del PRODUCTOR; (e) omitir la notificación de cambio de distribuidor o plataforma adicional en el plazo establecido en la Cláusula IV.3; (f) uso del beat en contenido prohibido por la Cláusula VIII; (g) no realizar el whitelisting requerido en el plazo establecido en la Cláusula VI.2; (h) el uso de los stems entregados como base para producciones, remezclas o canciones distintas a las Nuevas Canciones acordadas, o su comercialización como producción propia; (i) la omisión reiterada de los pagos manuales del 30% establecidos en la Cláusula IV.4 para plataformas sin split automático.

12\.10 Supervivencia: Las Cláusulas IV (Regalías y Porcentajes), V (Reconocimiento de Licencias Anteriores), VII (Créditos Obligatorios), VIII (Restricciones), IX (Garantías e Indemnidad), XII.4 (Confidencialidad), XII.5 (Notificaciones) y la presente cláusula de Supervivencia, sobrevivirán a la terminación o expiración de este contrato por cualquier causa.
...
|<p>`                               `**Dace**</p><p>**EL PRODUCTOR (LICENCIANTE)**</p>||<p> </p><p>**EL ARTISTA (LICENCIATARIO)**</p>|
| :- | :- | :- |
...
**IMPORTANTE:** Este contrato se perfecciona con pago + firma por cualquiera de estas vías: (1) firma electrónica oficial (DocuSign, Smallpdf) o ante notario — recomendada para montos altos; (2) firma manuscrita fotografiada o escaneada enviada por WhatsApp o correo — válida entre particulares. Guarda siempre: el contrato firmado, el comprobante de pago y el archivo del beat entregado.
**Página  de  \* *Este documento es confidencial. Prohibida su reproducción sin autorización.***
