...
| **Precio pactado:** | **\$ 350** **MXN** / **\$19.99 USD** |
|---------------------|--------------------------------------|
...
>
> 1.2 Unidades físicas: Hasta 2,000 (dos mil) copias físicas o descargas digitales.
>
> 1.3 Streaming: Hasta 100,000 (cien mil) reproducciones combinadas en todas las plataformas (Spotify, Apple Music, YouTube, redes sociales, etc.).
>
...
> El ARTISTA realizó el pago único e irrepetible de: \$350 MXN (para pagos dentro de México) / \$19.99 USD (para pagos internacionales). La moneda aplicable será la correspondiente al método de pago seleccionado y al país del ARTISTA, según acuerdo previo entre las partes.
>
