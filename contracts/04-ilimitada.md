**CONTRATO DE LICENCIA NO EXCLUSIVA DE USO DE BEAT / PRODUCCIÓN MUSICAL ILIMITADA (WAV + MP3 + Stems) — Uso No Exclusivo**

CONTRATO DE LICENCIA NO EXCLUSIVA

**DERECHOS DE USO, TÉRMINOS Y CONDICIONES**

***BEAT / PRODUCCIÓN MUSICAL — ILIMITADA (WAV + MP3 + Stems)***
...
|**Precio pactado:**|**$ 2,500** **MXN** / **$149.99 USD**|
| :- | :- |
...
El ARTISTA realizó el pago único e irrepetible de: $2,500 MXN (para pagos dentro de México) / $149.99 USD (para pagos internacionales). La moneda aplicable será la correspondiente al método de pago seleccionado y al país del ARTISTA, según acuerdo previo entre las partes.
