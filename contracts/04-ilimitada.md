...
| **Precio pactado:** | **$ 5,000** **MXN** / **$300 USD** |
|---------------------|--------------------------------------|
...
> El ARTISTA realizó el pago único e irrepetible de: $5,000 MXN (para pagos dentro de México) / $300 USD (para pagos internacionales). La moneda aplicable será la correspondiente al método de pago seleccionado y al país del ARTISTA, según acuerdo previo entre las partes.
>
